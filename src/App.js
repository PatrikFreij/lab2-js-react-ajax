...
class App extends Component {
  ...
  addBook = (title, author) => {
    ...
    fetch(
      `https://www.forverkliga.se/JavaScript/api/crud.php?op=insert&key=${
        this.state.apiKey
  ...
  delBook = id => {
    ...
    fetch(
      `https://www.forverkliga.se/JavaScript/api/crud.php?op=delete&key=${
        this.state.apiKey
      }&id=${id}`
    )
      .then(resp => resp.json())
  ...
  modifyBook = (title, author, id) => {
    ...
    fetch(
      `https://www.forverkliga.se/JavaScript/api/crud.php?op=update&key=${
        this.state.apiKey
  ...
  selectBooks = () => {
    ...
    fetch(
      `https://www.forverkliga.se/JavaScript/api/crud.php?op=select&key=${
        this.state.apiKey
      }`
    )
